...
class BaseOptions():
    def __init__(self):
        ...
        self.parser.add_argument("--threshold", type=float, nargs="+", default=[0.5], help="calculate seg_metrics (one or more values)")
        ...
        self.parser.add_argument('--save_coords', type=str2bool, default=True,
                                 help='Whether to save coordinate outputs after NMS')
